...
### <a name="cmd_analyze"></a>**gn analyze &lt;out_dir&gt; &lt;input_path&gt; &lt;output_path&gt;**&nbsp;[Back to Top](#title)
...
```
### <a name="cmd_args"></a>**gn args**: (command-line tool)&nbsp;[Back to Top](#title)
...
```
  ...
  gn args --list --args="os=\"android\" enable_doom_melon=true"
    ...
    arguments).
```
### <a name="cmd_check"></a>**gn check &lt;out_dir&gt; [&lt;label_pattern&gt;] [\--force] [\--check-generated]**&nbsp;[Back to Top](#title)
...
```
### <a name="cmd_clean"></a>**gn clean &lt;out_dir&gt;...**&nbsp;[Back to Top](#title)

```
  Deletes the contents of the output directory except for args.gn and
  creates a Ninja build environment sufficient to regenerate the build.
```
### <a name="cmd_clean_stale"></a>**gn clean_stale [\--ninja-executable=...] &lt;out_dir&gt;...**&nbsp;[Back to Top](#title)
...
```
### <a name="cmd_desc"></a>**gn desc**&nbsp;[Back to Top](#title)
...
```
### <a name="cmd_format"></a>**gn format [\--dump-tree] (\--stdin | &lt;list of build_files...&gt;)**&nbsp;[Back to Top](#title)
...
```
### <a name="cmd_gen"></a>**gn gen [\--check] [&lt;ide options&gt;] &lt;out_dir&gt;**&nbsp;[Back to Top](#title)
...
```
  ...
  --export-compile-commands[=<target_name1,target_name2...>]
      ...
      and not match:
       - "//foo:bar"
```
### <a name="cmd_help"></a>**gn help &lt;anything&gt;**&nbsp;[Back to Top](#title)
...
```
### <a name="cmd_ls"></a>**gn ls &lt;out_dir&gt; [&lt;label_pattern&gt;] [\--default-toolchain] [\--as=...]**&nbsp;[Back to Top](#title)
```
      [--type=...] [--testonly=...]
...
```
### <a name="cmd_meta"></a>**gn meta**&nbsp;[Back to Top](#title)
...
```
### <a name="cmd_outputs"></a>**gn outputs &lt;out_dir&gt; &lt;list of target or file names...&gt;**&nbsp;[Back to Top](#title)
...
```
### <a name="cmd_path"></a>**gn path &lt;out_dir&gt; &lt;target_one&gt; &lt;target_two&gt;**&nbsp;[Back to Top](#title)
...
```
### <a name="cmd_refs"></a>**gn refs**&nbsp;[Back to Top](#title)
...
### <a name="func_action"></a>**action**: Declare a target that runs a script a single time.&nbsp;[Back to Top](#title)
...
```
### <a name="func_action_foreach"></a>**action_foreach**: Declare a target that runs a script over a set of files.&nbsp;[Back to Top](#title)
...
```
### <a name="func_bundle_data"></a>**bundle_data**: [iOS/macOS] Declare a target without output.&nbsp;[Back to Top](#title)
...
```
### <a name="func_copy"></a>**copy**: Declare a target that copies files.&nbsp;[Back to Top](#title)
...
```
### <a name="func_create_bundle"></a>**create_bundle**: [ios/macOS] Build an iOS or macOS bundle.&nbsp;[Back to Top](#title)
...
```
### <a name="func_executable"></a>**executable**: Declare an executable target.&nbsp;[Back to Top](#title)
...
```
### <a name="func_generated_file"></a>**generated_file**: Declare a generated_file target.&nbsp;[Back to Top](#title)
...
```
### <a name="func_group"></a>**group**: Declare a named group of targets.&nbsp;[Back to Top](#title)
...
```
### <a name="func_loadable_module"></a>**loadable_module**: Declare a loadable module target.&nbsp;[Back to Top](#title)
...
```
### <a name="func_rust_library"></a>**rust_library**: Declare a Rust library target.&nbsp;[Back to Top](#title)
...
```
  ...
  Rust variables: aliased_deps, crate_root, crate_name
```
### <a name="func_rust_proc_macro"></a>**rust_proc_macro**: Declare a Rust procedural macro target.&nbsp;[Back to Top](#title)
...
```
  ...
  Rust variables: aliased_deps, crate_root, crate_name
```
### <a name="func_shared_library"></a>**shared_library**: Declare a shared library target.&nbsp;[Back to Top](#title)
...
```
  ...
  Rust variables: aliased_deps, crate_root, crate_name, crate_type
```
### <a name="func_source_set"></a>**source_set**: Declare a source set target.&nbsp;[Back to Top](#title)
...
```
  ...
  General: check_includes, configs, data, friend, inputs, metadata,
           ...
           visibility
```
### <a name="func_static_library"></a>**static_library**: Declare a static library target.&nbsp;[Back to Top](#title)
...
```
  ...
  target containing C and Rust sources is not).
```
### <a name="func_target"></a>**target**: Declare a target with the given programmatic type.&nbsp;[Back to Top](#title)
...
### <a name="func_assert"></a>**assert**: Assert an expression is true at generation time.&nbsp;[Back to Top](#title)
...
```
### <a name="func_config"></a>**config**: Defines a configuration object.&nbsp;[Back to Top](#title)
...
```
### <a name="func_declare_args"></a>**declare_args**: Declare build arguments.&nbsp;[Back to Top](#title)
...
```
  ...
  have no effect.
```
### <a name="func_defined"></a>**defined**: Returns whether an identifier is defined.&nbsp;[Back to Top](#title)
...
```
### <a name="func_exec_script"></a>**exec_script**: Synchronously run a script and return the output.&nbsp;[Back to Top](#title)
...
```
### <a name="func_filter_exclude"></a>**filter_exclude**: Remove values that match a set of patterns.&nbsp;[Back to Top](#title)
...
```
### <a name="func_filter_include"></a>**filter_include**: Remove values that do not match a set of patterns.&nbsp;[Back to Top](#title)
...
```
### <a name="func_filter_labels_exclude"></a>**filter_labels_exclude**: Remove labels that match a set of patterns.&nbsp;[Back to Top](#title)
...
```
### <a name="func_filter_labels_include"></a>**filter_labels_include**: Remove labels that do not match a set of patterns.&nbsp;[Back to Top](#title)
...
```
### <a name="func_foreach"></a>**foreach**: Iterate over a list.&nbsp;[Back to Top](#title)
...
```
  ...
  c
```
### <a name="func_forward_variables_from"></a>**forward_variables_from**: Copies variables from a different scope.&nbsp;[Back to Top](#title)
...
```
### <a name="func_get_label_info"></a>**get_label_info**: Get an attribute from a target's label.&nbsp;[Back to Top](#title)
...
```
### <a name="func_get_path_info"></a>**get_path_info**: Extract parts of a file or directory name.&nbsp;[Back to Top](#title)
...
```
### <a name="func_get_target_outputs"></a>**get_target_outputs**: [file list] Get the list of outputs from a target.&nbsp;[Back to Top](#title)
...
```
### <a name="func_getenv"></a>**getenv**: Get an environment variable.&nbsp;[Back to Top](#title)
...
```
### <a name="func_import"></a>**import**: Import a file into the current scope.&nbsp;[Back to Top](#title)
...
```
  ...
  import("my_vars.gni")
```
### <a name="func_label_matches"></a>**label_matches**: Returns true if the label matches any of a set of patterns.&nbsp;[Back to Top](#title)
...
```
  ...
  # result will be true
```
### <a name="func_not_needed"></a>**not_needed**: Mark variables from scope as not needed.&nbsp;[Back to Top](#title)
...
```
### <a name="func_pool"></a>**pool**: Defines a pool object.&nbsp;[Back to Top](#title)
...
```
### <a name="func_print"></a>**print**: Prints to the console.&nbsp;[Back to Top](#title)
...
```
  ...
  print(sources, deps)
```
### <a name="func_print_stack_trace"></a>**print_stack_trace**: Prints a stack trace.&nbsp;[Back to Top](#title)
...
```
### <a name="func_process_file_template"></a>**process_file_template**: Do template expansion over a list of files.&nbsp;[Back to Top](#title)
...
```
 ...
 The result in this case will be:
    [ "//out/Debug/foo.cc"
      ...
      "//out/Debug/bar.h" ]
```
### <a name="func_read_file"></a>**read_file**: Read a file into a variable.&nbsp;[Back to Top](#title)
...
```
### <a name="func_rebase_path"></a>**rebase_path**: Rebase a file or directory to another location.&nbsp;[Back to Top](#title)
...
```
### <a name="func_set_default_toolchain"></a>**set_default_toolchain**: Sets the default toolchain name.&nbsp;[Back to Top](#title)
...
```
### <a name="func_set_defaults"></a>**set_defaults**: Set default values for a target type.&nbsp;[Back to Top](#title)
...
```
### <a name="func_split_list"></a>**split_list**: Splits a list into N different sub-lists.&nbsp;[Back to Top](#title)
...
```
  ...
  Will print:
    [[1, 2], [3, 4], [5, 6]
```
### <a name="func_string_join"></a>**string_join**: Concatenates a list of strings with a separator.&nbsp;[Back to Top](#title)
...
```
    ...
    string_join("s", ["", ""])          --> "s"
```
### <a name="func_string_replace"></a>**string_replace**: Replaces substring in the given string.&nbsp;[Back to Top](#title)
...
```
  ...
  Will print:
    Hello, GN!
```
### <a name="func_string_split"></a>**string_split**: Split string into a list of strings.&nbsp;[Back to Top](#title)
...
```
### <a name="func_template"></a>**template**: Define a template rule.&nbsp;[Back to Top](#title)
...
```
### <a name="func_tool"></a>**tool**: Specify arguments to a toolchain tool.&nbsp;[Back to Top](#title)
...
```
### <a name="func_toolchain"></a>**toolchain**: Defines a toolchain.&nbsp;[Back to Top](#title)
...
```
### <a name="func_write_file"></a>**write_file**: Write a file to disk.&nbsp;[Back to Top](#title)
...
### <a name="var_current_cpu"></a>**current_cpu**: The processor architecture of the current toolchain.&nbsp;[Back to Top](#title)
...
```
### <a name="var_current_os"></a>**current_os**: The operating system of the current toolchain.&nbsp;[Back to Top](#title)
...
```
### <a name="var_current_toolchain"></a>**current_toolchain**: Label of the current toolchain.&nbsp;[Back to Top](#title)
...
```
  if (current_toolchain == "//build:64_bit_toolchain") {
    executable("output_thats_64_bit_only") {
      ...
```
### <a name="var_default_toolchain"></a>**default_toolchain**: [string] Label of the default toolchain.&nbsp;[Back to Top](#title)
...
```
### <a name="var_gn_version"></a>**gn_version**: [number] The version of gn.&nbsp;[Back to Top](#title)
...
```
### <a name="var_host_cpu"></a>**host_cpu**: The processor architecture that GN is running on.&nbsp;[Back to Top](#title)
...
```
  ...
  - "x86"
```
### <a name="var_host_os"></a>**host_os**: [string] The operating system that GN is running on.&nbsp;[Back to Top](#title)
...
```
  ...
  - "win"
```
### <a name="var_invoker"></a>**invoker**: [string] The invoking scope inside a template.&nbsp;[Back to Top](#title)
...
```
### <a name="var_python_path"></a>**python_path**: Absolute path of Python.&nbsp;[Back to Top](#title)
...
```
### <a name="var_root_build_dir"></a>**root_build_dir**: [string] Directory where build commands are run.&nbsp;[Back to Top](#title)
...
```
### <a name="var_root_gen_dir"></a>**root_gen_dir**: Directory for the toolchain's generated files.&nbsp;[Back to Top](#title)
...
```
### <a name="var_root_out_dir"></a>**root_out_dir**: [string] Root directory for toolchain output files.&nbsp;[Back to Top](#title)
...
```
### <a name="var_target_cpu"></a>**target_cpu**: The desired cpu architecture for the build.&nbsp;[Back to Top](#title)
...
```
  ...
  - "loong64"
```
### <a name="var_target_gen_dir"></a>**target_gen_dir**: Directory for a target's generated files.&nbsp;[Back to Top](#title)
...
```
### <a name="var_target_name"></a>**target_name**: [string] The name of the current target.&nbsp;[Back to Top](#title)
...
```
### <a name="var_target_os"></a>**target_os**: The desired operating system for the build.&nbsp;[Back to Top](#title)
...
```
  ...
  - "win"
```
### <a name="var_target_out_dir"></a>**target_out_dir**: [string] Directory for target output files.&nbsp;[Back to Top](#title)
...
### <a name="var_aliased_deps"></a>**aliased_deps**: [scope] Set of crate-dependency pairs.&nbsp;[Back to Top](#title)
...
```
### <a name="var_all_dependent_configs"></a>**all_dependent_configs**: Configs to be forced on dependents.&nbsp;[Back to Top](#title)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_allow_circular_includes_from"></a>**allow_circular_includes_from**: Permit includes from deps.&nbsp;[Back to Top](#title)
...
```
### <a name="var_arflags"></a>**arflags**: Arguments passed to static_library archiver.&nbsp;[Back to Top](#title)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_args"></a>**args**: (target variable) Arguments passed to an action.&nbsp;[Back to Top](#title)
...
```
### <a name="var_asmflags"></a>**asmflags**: Flags passed to the assembler.&nbsp;[Back to Top](#title)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_assert_no_deps"></a>**assert_no_deps**: Ensure no deps on these targets.&nbsp;[Back to Top](#title)
...
```
### <a name="var_bridge_header"></a>**bridge_header**: [string] Path to C/Objective-C compatibility header.&nbsp;[Back to Top](#title)
...
```
### <a name="var_bundle_contents_dir"></a>**bundle_contents_dir**: Expansion of {{bundle_contents_dir}} in&nbsp;[Back to Top](#title)
```
                             create_bundle.
...
```
### <a name="var_bundle_deps_filter"></a>**bundle_deps_filter**: [label list] A list of labels that are filtered out.&nbsp;[Back to Top](#title)
...
```
### <a name="var_bundle_executable_dir"></a>**bundle_executable_dir**&nbsp;[Back to Top](#title)
...
```
  ...
  See "gn help bundle_root_dir" for examples.
```
### <a name="var_bundle_resources_dir"></a>**bundle_resources_dir**&nbsp;[Back to Top](#title)
...
```
  ...
  See "gn help bundle_root_dir" for examples.
```
### <a name="var_bundle_root_dir"></a>**bundle_root_dir**: Expansion of {{bundle_root_dir}} in create_bundle.&nbsp;[Back to Top](#title)
...
```
### <a name="var_cflags"></a>**cflags***: Flags passed to the C compiler.&nbsp;[Back to Top](#title)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_cflags_c"></a>**cflags***: Flags passed to the C compiler.&nbsp;[Back to Top](#title)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_cflags_cc"></a>**cflags***: Flags passed to the C compiler.&nbsp;[Back to Top](#title)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_cflags_objc"></a>**cflags***: Flags passed to the C compiler.&nbsp;[Back to Top](#title)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_cflags_objcc"></a>**cflags***: Flags passed to the C compiler.&nbsp;[Back to Top](#title)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_check_includes"></a>**check_includes**: [boolean] Controls whether a target's files are checked.&nbsp;[Back to Top](#title)
...
```
### <a name="var_code_signing_args"></a>**code_signing_args**: [string list] [deprecated] Args for the post-processing script.&nbsp;[Back to Top](#title)
...
```
### <a name="var_code_signing_outputs"></a>**code_signing_outputs**: [file list] [deprecated] Outputs of the post-processing step.&nbsp;[Back to Top](#title)
...
```
  ...
  See also "gn help create_bundle" and "gn help post_processing_args".
```
### <a name="var_code_signing_script"></a>**code_signing_script**: [file name] [deprecated] Script for the post-processing step."&nbsp;[Back to Top](#title)
...
```
  ...
  See also "gn help create_bundle" and "gn help post_processing_args".
```
### <a name="var_code_signing_sources"></a>**code_signing_sources**: [file list] [deprecated] Sources for the post-processing step.&nbsp;[Back to Top](#title)
...
```
  ...
  See also "gn help create_bundle" and "gn help post_processing_args".
```
### <a name="var_complete_static_lib"></a>**complete_static_lib**: [boolean] Links all deps into a static library.&nbsp;[Back to Top](#title)
...
```
### <a name="var_configs"></a>**configs**: Configs applying to this target or config.&nbsp;[Back to Top](#title)
...
```
### <a name="var_contents"></a>**contents**: Contents to write to file.&nbsp;[Back to Top](#title)

```
  The contents of the file for a generated_file target.
  See "gn help generated_file".
```
### <a name="var_crate_name"></a>**crate_name**: [string] The name for the compiled crate.&nbsp;[Back to Top](#title)
...
```
### <a name="var_crate_root"></a>**crate_root**: [string] The root source file for a binary or library.&nbsp;[Back to Top](#title)
...
```
  ...
  only one file.
```
### <a name="var_crate_type"></a>**crate_type**: [string] The type of linkage to use on a shared_library.&nbsp;[Back to Top](#title)
...
```
  ...
  automatically.
```
### <a name="var_data"></a>**data**: Runtime data file dependencies.&nbsp;[Back to Top](#title)
...
```
### <a name="var_data_deps"></a>**data_deps**: Non-linked dependencies.&nbsp;[Back to Top](#title)
...
```
### <a name="var_data_keys"></a>**data_keys**: Keys from which to collect metadata.&nbsp;[Back to Top](#title)
...
```
  ...
  See "gn help generated_file".
```
### <a name="var_defines"></a>**defines**: C preprocessor defines.&nbsp;[Back to Top](#title)
...
```
### <a name="var_depfile"></a>**depfile**: [string] File name for input dependencies for actions.&nbsp;[Back to Top](#title)
...
```
### <a name="var_deps"></a>**deps**: Private linked dependencies.&nbsp;[Back to Top](#title)
...
```
### <a name="var_externs"></a>**externs**: [scope] Set of Rust crate-dependency pairs.&nbsp;[Back to Top](#title)
...
```
### <a name="var_framework_dirs"></a>**framework_dirs**: [directory list] Additional framework search directories.&nbsp;[Back to Top](#title)
...
```
### <a name="var_frameworks"></a>**frameworks**: [name list] Name of frameworks that must be linked.&nbsp;[Back to Top](#title)
...
```
### <a name="var_friend"></a>**friend**: Allow targets to include private headers.&nbsp;[Back to Top](#title)
...
```
### <a name="var_gen_deps"></a>**gen_deps**: Declares targets that should generate when this one does.&nbsp;[Back to Top](#title)
...
```
### <a name="var_include_dirs"></a>**include_dirs**: Additional include directories.&nbsp;[Back to Top](#title)
...
```
### <a name="var_inputs"></a>**inputs**: Additional compile-time dependencies.&nbsp;[Back to Top](#title)
...
```
### <a name="var_ldflags"></a>**ldflags**: Flags passed to the linker.&nbsp;[Back to Top](#title)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_lib_dirs"></a>**lib_dirs**: Additional library directories.&nbsp;[Back to Top](#title)
...
```
### <a name="var_libs"></a>**libs**: Additional libraries to link.&nbsp;[Back to Top](#title)
...
```
  ...
  On Linux:
    libs = [ "ld" ]
```
### <a name="var_metadata"></a>**metadata**: Metadata of this target.&nbsp;[Back to Top](#title)
...
```
### <a name="var_mnemonic"></a>**mnemonic**: [string] Prefix displayed when ninja runs this action.&nbsp;[Back to Top](#title)
...
```
### <a name="var_module_name"></a>**module_name**: [string] The name for the compiled module.&nbsp;[Back to Top](#title)
...
```
### <a name="var_output_conversion"></a>**output_conversion**: Data format for generated_file targets.&nbsp;[Back to Top](#title)

```
  Controls how the "contents" of a generated_file target is formatted.
  See `gn help io_conversion`.
```
### <a name="var_output_dir"></a>**output_dir**: [directory] Directory to put output file in.&nbsp;[Back to Top](#title)
...
```
### <a name="var_output_extension"></a>**output_extension**: Value to use for the output's file extension.&nbsp;[Back to Top](#title)
...
```
### <a name="var_output_name"></a>**output_name**: Define a name for the output file other than the default.&nbsp;[Back to Top](#title)
...
```
### <a name="var_output_prefix_override"></a>**output_prefix_override**: Don't use prefix for output name.&nbsp;[Back to Top](#title)
...
```
### <a name="var_outputs"></a>**outputs**: Output files for actions and copy targets.&nbsp;[Back to Top](#title)
...
```
### <a name="var_partial_info_plist"></a>**partial_info_plist**: [filename] Path plist from asset catalog compiler.&nbsp;[Back to Top](#title)
...
```
### <a name="var_pool"></a>**pool**: Label of the pool used by binary targets actions.&nbsp;[Back to Top](#title)
...
```
### <a name="var_post_processing_args"></a>**post_processing_args**: [string list] Args for the post-processing script.&nbsp;[Back to Top](#title)
...
```
### <a name="var_post_processing_outputs"></a>**post_processing_outputs**: [file list] Outputs of the post-processing step.&nbsp;[Back to Top](#title)
...
```
  ...
  See also "gn help create_bundle".
```
### <a name="var_post_processing_script"></a>**post_processing_script**: [file name] Script for the post-processing step."&nbsp;[Back to Top](#title)
...
```
  ...
  See also "gn help create_bundle".
```
### <a name="var_post_processing_sources"></a>**post_processing_sources**: [file list] Sources for the post-processing step.&nbsp;[Back to Top](#title)
...
```
  ...
  See also "gn help create_bundle".
```
### <a name="var_precompiled_header"></a>**precompiled_header**: [string] Header file to precompile.&nbsp;[Back to Top](#title)
...
```
  ...
  And then define a target that uses the config:
    ...
    executable("doom_melon") {
      ...
      ...
```
### <a name="var_precompiled_header_type"></a>**precompiled_header_type**: [string] "gcc" or "msvc".&nbsp;[Back to Top](#title)

```
  See "gn help precompiled_header".
```
### <a name="var_precompiled_source"></a>**precompiled_source**: [file name] Source file to precompile.&nbsp;[Back to Top](#title)
...
```
### <a name="var_product_type"></a>**product_type**: [string] Product type for the bundle.&nbsp;[Back to Top](#title)
...
```
### <a name="var_public"></a>**public**: Declare public header files for a target.&nbsp;[Back to Top](#title)
...
```
  ...
  No files are public (no targets may include headers from this one):
    ...
    public = []
```
### <a name="var_public_configs"></a>**public_configs**: Configs to be applied on dependents.&nbsp;[Back to Top](#title)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_public_deps"></a>**public_deps**: Declare public dependencies.&nbsp;[Back to Top](#title)
...
```
### <a name="var_rebase"></a>**rebase**: Rebase collected metadata as files.&nbsp;[Back to Top](#title)
...
```
### <a name="var_response_file_contents"></a>**response_file_contents**: Contents of a response file for actions.&nbsp;[Back to Top](#title)
...
```
### <a name="var_rustflags"></a>**rustflags**: Flags passed to the Rust compiler.&nbsp;[Back to Top](#title)
...
```
### <a name="var_script"></a>**script**: Script file for actions.&nbsp;[Back to Top](#title)
...
```
  ...
  action_foreach").
```
### <a name="var_sources"></a>**sources**: Source files for a target&nbsp;[Back to Top](#title)
...
```
### <a name="var_swiftflags"></a>**swiftflags**: Flags passed to the swift compiler.&nbsp;[Back to Top](#title)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_testonly"></a>**testonly**: Declares a target must only be used for testing.&nbsp;[Back to Top](#title)
...
```
### <a name="var_transparent"></a>**transparent**: [bool] True if the bundle is transparent.&nbsp;[Back to Top](#title)
...
```
### <a name="var_visibility"></a>**visibility**: A list of labels that can depend on a target.&nbsp;[Back to Top](#title)
...
```
  ...
  any targets in "//bar/" and any subdirectory thereof.
    visibility = [ "./*", "//bar/*" ]
```
### <a name="var_walk_keys"></a>**walk_keys**: Key(s) for managing the metadata collection walk.&nbsp;[Back to Top](#title)
...
```
  ...
  See "gn help generated_file".
```
### <a name="var_weak_frameworks"></a>**weak_frameworks**: [name list] Name of frameworks that must be weak linked.&nbsp;[Back to Top](#title)
...
```
### <a name="var_write_runtime_deps"></a>**write_runtime_deps**: Writes the target's runtime_deps to the given path.&nbsp;[Back to Top](#title)
...
```
### <a name="var_xcasset_compiler_flags"></a>**xcasset_compiler_flags**: Flags passed to xcassets compiler.&nbsp;[Back to Top](#title)
...
```
### <a name="var_xcode_extra_attributes"></a>**xcode_extra_attributes**: [scope] Extra attributes for Xcode projects.&nbsp;[Back to Top](#title)
...
```
  ...
  See "gn help create_bundle" for more information.
```
### <a name="var_xcode_test_application_name"></a>**xcode_test_application_name**: Name for Xcode test target.&nbsp;[Back to Top](#title)
...
### <a name="buildargs"></a>**Build Arguments Overview**&nbsp;[Back to Top](#title)
...
```
### <a name="dotfile"></a>**.gn file**&nbsp;[Back to Top](#title)
...
```
### <a name="execution"></a>**Build graph and execution overview**&nbsp;[Back to Top](#title)
...
```
### <a name="grammar"></a>**Language and grammar for GN build files**&nbsp;[Back to Top](#title)
...
```
### <a name="io_conversion"></a>**Input and output conversion**&nbsp;[Back to Top](#title)
...
```
  ...
  "trim ..." (input only)
      ...
      whitespace anyway.
```
### <a name="file_pattern"></a>**File patterns**&nbsp;[Back to Top](#title)
...
```
### <a name="label_pattern"></a>**Label patterns**&nbsp;[Back to Top](#title)
...
```
  ...
  toolchain name).
    ...
    "//foo/*(//build/toolchain:win)"
        ...
        toolchain.
```
### <a name="labels"></a>**About labels**&nbsp;[Back to Top](#title)
...
```
### <a name="metadata_collection"></a>**Metadata Collection**&nbsp;[Back to Top](#title)
...
```
### <a name="ninja_rules"></a>**Ninja build rules**&nbsp;[Back to Top](#title)
...
```
### <a name="nogncheck"></a>**nogncheck**: Skip an include line from checking.&nbsp;[Back to Top](#title)
...
```
  ...
  "gn help check_includes".
```
### <a name="runtime_deps"></a>**Runtime dependencies**&nbsp;[Back to Top](#title)
...
```
### <a name="source_expansion"></a>**How Source Expansion Works**&nbsp;[Back to Top](#title)
...
```
### <a name="switch_list"></a>**Available global switches**&nbsp;[Back to Top](#title)
